...
> **Release:** PIXL Renderer 1.0.2. See installation requirements and validation limits below before installing. Optional DLSSG proxy and Neural Rendering paths remain experimental.
