...
/**
 * Internationalization (i18n) engine for PIXL Renderer.
 *
 ...
 *
 *     ImGui::Text("%s", T("menu.home.welcome", "Welcome to PIXL Renderer"));
 *
...
private:
	...
	// Current locale strings (may be empty for "en" â€” we just use fallback_)
	std::unordered_map<std::string, std::string> strings_;

	// English fallback (always loaded from en.json)
	std::unordered_map<std::string, std::string> fallback_;

	// (locale_code, display_name) â€” discovered from Translations/*.json
	std::vector<std::pair<std::string, std::string>> availableLocales_;

	// Cache of inline defaults and missing keys â€” ensures pointer stability.
...
// â”€â”€â”€ Convenience free function â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/**
 * Get a translated string. Two usage patterns:
 *
 *   // Preferred: inline default â€” developer only touches this one file
 *   T("menu.home.welcome", "Welcome to PIXL Renderer")
 *
...
// â”€â”€â”€ Scoped prefix macro â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/**
 * TKEY(suffix) â€” Compile-time key prefix concatenation.
 *
 ...
 *
 * C++ adjacent string literals ("a" "b" â†’ "ab") do the concatenation
 * at compile time â€” zero runtime cost.
 */
