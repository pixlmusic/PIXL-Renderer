...
public:
	...
	struct alignas(16) PixlGIDebugData
	{
		uint mode = 0;
		float gain = 1.0f;
		uint specularOcclusionEnabled = 1;
		float specularOcclusionStrength = 0.9f;
	};
	STATIC_ASSERT_ALIGNAS_16(PixlGIDebugData);
	eastl::unique_ptr<ConstantBuffer> pixlGIDebugCB;
