...
using PBRFlags = PhysicalMaterial::MaterialTrait;
using PBRShaderFlags = PhysicalMaterial::RasterFlag;
...
public:
	...
	{
		MaterialForge::PBRTextureSetData* textureSetData = nullptr;
		MaterialForge::PBRMaterialObjectData* materialObjectData = nullptr;
		/**
	 ...
	 */
	RE::BSShaderMaterial::Feature GetFeature() const override;  // 06
	/**
	 ...
	 */
	void ApplyTextureSetData(const MaterialForge::PBRTextureSetData& textureSetData);
	/**
	 ...
	 */
	void ApplyMaterialObjectData(const MaterialForge::PBRMaterialObjectData& materialObjectData);
	/**
	...
	/**
	 * @brief Resolves this game material into the backend-neutral physical-material contract.
	 * @param defaultBlack Skyrim's default black texture, used to identify absent optional maps.
	 * @param defaultWhite Skyrim's default white texture, used to identify absent feature maps.
	 * @param projectedUVActive Whether the current draw uses Skyrim's projected-UV material layer.
	 * @return A versioned descriptor suitable for raster or future ray-tracing backends.
	 */
	[[nodiscard]] PhysicalMaterial::Descriptor GetPhysicalMaterialDescriptor(
