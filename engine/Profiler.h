...
public:
	...
	/**
	 * @brief Registers optional callbacks invoked at pass begin/end for PIXL diagnostics.
	 ...
	 * @param name Pass identifier (e.g. "RenderModule::PassName"). Implicitly calls BeginFrame if needed.
	 */
	 ...
	 * @param featureName RenderModule name; timers matching "featureName::*" are removed.
	 */
