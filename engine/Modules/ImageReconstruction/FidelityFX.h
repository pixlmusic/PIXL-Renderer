...
/** @brief Manages AMD FidelityFX Super Resolution 3 imageReconstruction and frame generation. */
class FidelityFX
{
public:
	static constexpr const wchar_t* PluginDir = L"Data\\Shaders\\ImageReconstruction\\FidelityFX";
	...
	/** @brief Creates FSR3 imageReconstruction resources including scratch buffers and context. */
	void CreateFSRResources();

	/** @brief Destroys FSR3 imageReconstruction resources and frees the scratch buffer. */
	void DestroyFSRResources();

	/**
	 * @brief Dispatches FSR3 imageReconstruction for the current frame.
