...
/** @brief Manages NVIDIA Streamline integration for DLSS imageReconstruction and Reflex latency reduction. */
class Streamline
{
public:
	...
	/**
	 * @brief Dispatches DLSS imageReconstruction for the current frame.
