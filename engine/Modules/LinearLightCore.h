...
struct LinearLightCore : RenderModule
{
	static LinearLightCore* GetSingleton()
	{
		static LinearLightCore singleton;
		return &singleton;
	}

	virtual inline std::string GetName() override { return "Linear Light Core"; }
	virtual std::string GetDisplayName() override { return T("feature.linear_light_core.name", "Linear Light Core"); }
	virtual inline std::string GetShortName() override { return "LinearLightCore"; }
	...
	{
		return { T("feature.linear_light_core.description", "Linear Light Core does internal color space conversion to improve lighting calculation accuracy."),
			{ T("feature.linear_light_core.key_feature_1", "Customizable gamma correction"),
				T("feature.linear_light_core.key_feature_2", "Corrects lighting calculations"),
				T("feature.linear_light_core.key_feature_3", "Makes PBR really work") } };
	};
	...
	struct Settings
	{
		uint enableLinearLightCore = false;
