...
void ABTestingManager::Enable()
{
	if (!abTestingEnabled) {
		...
		auto& pulseProfiler = globals::pipeline::pulseProfiler;
		...
		bool overlayWasEnabled = pulseProfiler.settings.ShowInOverlay;
		...
		pulseProfiler.settings.ShowInOverlay = overlayWasEnabled;
