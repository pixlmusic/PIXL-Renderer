...
struct InteriorDaylight : RenderModule
{
public:
	virtual inline std::string GetName() override { return "Interior Daylight"; }
	virtual std::string GetDisplayName() override { return T("feature.interior_daylight.name", "Interior Daylight"); }
	virtual inline std::string GetShortName() override { return "InteriorDaylight"; }
	...
	/** @brief Draws the ImGui settings UI for Interior Daylight configuration. */
	...
	bool IsActiveInteriorDaylight() const { return loaded && isInteriorWithSun.load(); }
...
private:
	...
	static RE::TESWorldSpace* enableInteriorDaylight;
	static RE::TESWorldSpace* disableInteriorDaylight;
