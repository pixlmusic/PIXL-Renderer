...
#include "PulseProfiler/ABTesting/ABTestAggregator.h"
...
struct PulseProfiler : OverlayFeature
{
	// ============================================================================
	// VIRTUAL OVERRIDES (RenderModule.h interface)
	// ============================================================================
	std::string GetName() override { return "Pulse Profiler"; }
	virtual std::string GetDisplayName() override { return T("feature.performance_overlay.name", "Pulse Profiler"); }
	std::string GetShortName() override { return "PulseProfiler"; }
