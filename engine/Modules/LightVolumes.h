...
struct LightVolumes : RenderModule
{
public:
	...
	virtual inline std::string GetName() override { return "Light Volumes"; }
	virtual std::string GetDisplayName() override { return T("feature.light_volumes.name", "Light Volumes"); }
	/** @brief Returns the short identifier used for file paths and logging. */
	virtual inline std::string GetShortName() override { return "LightVolumes"; }
	...
	{
		return { T("feature.light_volumes.description", "Light Volumes creates realistic light scattering effects through fog, dust, and atmospheric particles.\nThis adds dramatic god rays and atmospheric depth to both interior and exterior environments."),
			{ T("feature.light_volumes.key_feature_1", "Realistic light scattering"),
				T("feature.light_volumes.key_feature_2", "God rays and atmospheric effects"),
				T("feature.light_volumes.key_feature_3", "Separate interior/exterior settings"),
				T("feature.light_volumes.key_feature_4", "Configurable quality levels"),
				T("feature.light_volumes.key_feature_5", "Enhanced atmospheric immersion") } };
	};
...
private:
	...
	bool inMapMenu = false;
	bool atmosphereMapProfileActive = false;
