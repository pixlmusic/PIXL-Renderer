...
ImU32 PulsePanelRenderer::GetGroupColor(const std::string& groupName)
{
...
uint32_t PulsePanelRenderer::ToLegitColor(ImU32 imColor)
{
...
ImVec4 PulsePanelRenderer::HeatColor(float value, float maxValue)
{
	if (maxValue <= 0.0f)
...
void PulsePanelRenderer::TextHeat(const char* fmt, float value, float maxValue)
{
...
void PulsePanelRenderer::RenderTimingModeToggle()
{
...
void PulsePanelRenderer::SetupTimingTableColumns(bool includePercentColumn)
{
...
std::string PulsePanelRenderer::GetFeatureTimerPrefix(const std::string& featurePrefix)
{
	return featurePrefix + "::";
}

bool PulsePanelRenderer::IsFeatureTimerResult(const Profiler::TimerResult& result, std::string_view prefix)
{
