#include "WorkshopToolsRenderer.h"
...
void WorkshopToolsRenderer::RenderLoggingSection()
{
...
void WorkshopToolsRenderer::RenderShaderDebugSection()
{
	auto shaderCache = globals::shaderCache;
...
void WorkshopToolsRenderer::RenderDisableAtBootSection(const std::function<void()>& drawDisableAtBootSettings)
{
	drawDisableAtBootSettings();
}

void WorkshopToolsRenderer::RenderDeveloperSection()
{
	auto shaderCache = globals::shaderCache;
...
void WorkshopToolsRenderer::RenderTestingSection()
{
	PIXLRenderer::WorldBenchmark::GetSingleton().DrawUI();
	ImGui::Spacing();
