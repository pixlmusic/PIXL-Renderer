...
/**
 * @brief Manages layered JSON override system for PIXL Renderer features
 *
...
public:
	 ...
	 * @param featureName RenderModule name (empty for global)
	...
	/**
	 * @brief Reports an override failure to the RenderModule Issues system
	 * @param modName Name of the mod
	 * @param featureName RenderModule name (empty for global overrides)
