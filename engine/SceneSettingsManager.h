 ...
 * RenderModule::SaveSettings/LoadSettings.
...
public:
	 ...
	 *
	 * Same pattern as SkyBounce::MenuOpenCloseEventHandler.
	 */
	...
	struct SettingEntry
	{
		std::string featureShortName;  // RenderModule's GetShortName()
