...
namespace PBR
{
	...
	namespace Flags
	{
		// Raster ABI: keep bit values synchronized with PhysicalMaterial::RasterFlag in
		// src/MaterialForge/PhysicalMaterial.h. Ray-tracing backends consume the separated
		// physical feature and texture masks instead of this legacy combined mask.
	...
	{
		float reflectance = (1.0f - IOR) / max(1.0f + IOR, EPSILON_DIVISION);
